...
When you are done working with the json files, convert them to rton and copy the files to the latest version of the CDN.And change names files name to be like
PlantLevels.rton
products.rton
